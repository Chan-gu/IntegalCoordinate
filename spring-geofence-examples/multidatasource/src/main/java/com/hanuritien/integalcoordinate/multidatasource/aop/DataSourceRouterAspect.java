package com.hanuritien.integalcoordinate.multidatasource.aop;
...
import com.hanuritien.integalcoordinate.multidatasource.DataSourceNameContextHolder;
...
public class DataSourceRouterAspect implements Ordered {
     ...
     */
    @Pointcut( "@within(com.hanuritien.integalcoordinate.multidatasource.DataSource)" )
    public void classDataSourceAnno() {}
    /**
     * 데이타소스 어노테이션 메소드를 나타내는 Pointcut
     */
    @Pointcut( "@annotation(com.hanuritien.integalcoordinate.multidatasource.DataSource)" )
