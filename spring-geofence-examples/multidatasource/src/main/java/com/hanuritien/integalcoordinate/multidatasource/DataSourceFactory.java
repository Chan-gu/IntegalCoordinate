...
//import static com.hanuritien.integalcoordinate.MultiDataSourceRegistrar.*;
...
public class DataSourceFactory implements FactoryBean<javax.sql.DataSource> {
    ...
    public DataSource getObject() throws Exception {
        ...
        MultiDataSourceRegistrar.bindProperties(dataSource, environmentPrefix, environment);
        return dataSource;
    }
